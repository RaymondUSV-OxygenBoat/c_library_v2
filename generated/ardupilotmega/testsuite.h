...
static void mavlink_test_raymond_sensor_msg(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_RAYMOND_SENSOR_MSG >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_raymond_sensor_msg_t packet_in = {
        963497464,45.0,73.0,101.0,129.0,157.0,185.0
    };
    mavlink_raymond_sensor_msg_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_boot_ms = packet_in.time_boot_ms;
        packet1.o2_saturation = packet_in.o2_saturation;
        packet1.o2_concentration = packet_in.o2_concentration;
        packet1.front_obstacle_distance = packet_in.front_obstacle_distance;
        packet1.back_obstacle_distance = packet_in.back_obstacle_distance;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_RAYMOND_SENSOR_MSG_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_RAYMOND_SENSOR_MSG_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_raymond_sensor_msg_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_raymond_sensor_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_raymond_sensor_msg_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.o2_saturation , packet1.o2_concentration , packet1.front_obstacle_distance , packet1.back_obstacle_distance , packet1.water_depth , packet1.water_temperature );
    mavlink_msg_raymond_sensor_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_raymond_sensor_msg_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.o2_saturation , packet1.o2_concentration , packet1.front_obstacle_distance , packet1.back_obstacle_distance , packet1.water_depth , packet1.water_temperature );
    mavlink_msg_raymond_sensor_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_raymond_sensor_msg_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_raymond_sensor_msg_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.o2_saturation , packet1.o2_concentration , packet1.front_obstacle_distance , packet1.back_obstacle_distance , packet1.water_depth , packet1.water_temperature );
    mavlink_msg_raymond_sensor_msg_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("RAYMOND_SENSOR_MSG") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_RAYMOND_SENSOR_MSG) != NULL);
#endif
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_raymond_sensor_msg(system_id, component_id, last_msg);
}
